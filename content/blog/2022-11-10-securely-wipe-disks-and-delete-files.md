...
![alt text](/website/static/assets/images/blogs/dban-1.png)

Pressing `F3` displays the list of available commands:

![alt text](/website/static/assets/images/blogs/dban-2.png)
...
![alt text](/website/static/assets/images/blogs/dban-3.png)

Then the program starts wipe the disk, (be careful because there is no confirmation after the commands):

![alt text](/website/static/assets/images/blogs/dban-4.png)
...
![alt text](/website/static/assets/images/blogs/dban-5.png)

Press `M` for select the wipe method:

![alt text](/website/static/assets/images/blogs/dban-6.png)

After selecting the preferred method, press `F10` to start the wipe:

![alt text](/website/static/assets/images/blogs/dban-7.png)
